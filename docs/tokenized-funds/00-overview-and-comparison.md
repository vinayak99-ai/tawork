...
| [09](./09-ta-data-flows-and-message-sequencing.md) | Direct-to-TA data flows for a domestic corporate treasury client investing in a domestic money market fund via an investor portal. Covers legal-entity KYC (FinCEN beneficial ownership), intraday MMF NAV striking, ACH/NACHA/Fedwire, and 16 scenarios spanning subscriptions/redemptions, dividend & capital gain distributions (cash and reinvest, incl. the daily-accrual tax calculation and state government-obligations exclusion), tax certification, Blue Sky/24f-2, wash sales, escheatment, non-financial maintenance, and TA/fund compliance reporting (Form TA-2, Rule 17Ad-13/17Ad-11, SAR/OFAC, Form N-CEN/N-MFP/N-CSR) | N/A — regulatory baseline |
