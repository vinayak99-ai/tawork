...
| [09](./09-ta-data-flows-and-message-sequencing.md) | Direct-to-TA data flows for a domestic corporate treasury client investing in a domestic money market fund via an investor portal. Covers legal-entity KYC (FinCEN beneficial ownership), intraday MMF NAV striking, ACH/NACHA/Fedwire, and 7 scenarios including the corporate 1099-DIV exemption/backup-withholding logic | N/A — regulatory baseline |
