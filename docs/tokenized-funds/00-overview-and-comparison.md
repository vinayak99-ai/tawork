...
| [09](./09-ta-data-flows-and-message-sequencing.md) | End-to-end data flows and messaging between the order portal, TA, fund accounting, payment agent/bank, NSCC, custodian, and shareholder reporting — real message standards (SWIFT setr, NACHA, Fedwire, camt) and full step-by-step sequences for a subscription, redemption, and dividend cycle | N/A — regulatory baseline |
